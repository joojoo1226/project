...
<body>
	...
	<section id="modifyForm">
		...
		<form action="BoardModifyPro.bo" name="boardForm" method="post">
			<input type="hidden" name="board_name" value="${param.board_num }">
			...
			<table>
				...
				<tr>
					...
					<td class="td_right">
						<textarea rows="15" cols="40" name="board_content" required="required">
							${board.board_content }
						</textarea>
					</td>
				</tr>
			...
			<section id="commandCell">
				<input type="submit" value="수정" onclick="location.href='BoardList.bo?pageNum=${param.pageNum }'">&nbsp;&nbsp;
