...
FileBoardDTO fileBoard = dao.selectBoard(idx);
%>	
<!DOCTYPE html>
<html>
<head>
...
<body>
	<div id="wrap">
		...
		<article>
			<h1>Driver Update</h1>
			<form action="driver_updatePro.jsp" method="post"> <!-- updateBoard() -->
				...
				<table id="notice">
					<tr>
						<td>글쓴이</td>
						<td><input type="text" name="name" required="required" value="<%=fileBoard.getName()%>"></td>
					</tr>
					<tr>
						<td>비밀번호</td>
